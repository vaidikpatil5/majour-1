...
export default function Home() {
  ...
  return (
    // 'relative' class add kiya taaki button absolute position le sake
    <div className="relative flex h-screen w-full bg-background text-foreground dark">
      
      {/* --- START: BACK BUTTON --- */}
      <Link 
        href="/" 
        className="absolute top-4 right-4 z-100 flex items-center gap-2 rounded-full bg-zinc-900/80 px-4 py-2 text-sm font-medium text-white border border-white/10 backdrop-blur-md shadow-lg transition-all hover:bg-teal-600 hover:scale-105"
      >
